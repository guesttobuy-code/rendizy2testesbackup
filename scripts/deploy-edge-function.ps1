...
# ============================================================================
# STEP 3: REINICIAR SERVIDOR DEV
# ============================================================================

Write-Host "🔄 Reiniciando servidor local (vite)..." -ForegroundColor Yellow

# Encerrar processo na porta 5173 (se existir)
$port = 5173
$conn = Get-NetTCPConnection -LocalPort $port -ErrorAction SilentlyContinue | Select-Object -First 1
if ($conn) {
    $pid = $conn.OwningProcess
    Write-Host "   Encerrando PID $pid na porta $port" -ForegroundColor Gray
    Stop-Process -Id $pid -Force
}

# Subir novamente em uma nova janela
$devCmd = "Set-Location `"$repoRoot`"; npm run dev:5173"
Start-Process -FilePath "pwsh" -ArgumentList "-NoProfile", "-Command", $devCmd

Write-Host "✅ Servidor religado" -ForegroundColor Green
