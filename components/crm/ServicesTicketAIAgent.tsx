...
import { ChevronUp, ChevronDown, Bot, Sparkles, Calendar, Mail, CheckCircle2, ListTodo } from 'lucide-react';
import { cn } from '../ui/utils';

interface ServicesTicketAIAgentProps {
...
export function ServicesTicketAIAgent({
  ticket,
  expanded,
  onToggleExpand,
  onUpdate,
}: ServicesTicketAIAgentProps) {
      ...
      <Card className="rounded-none border-x-0 border-b-0 flex flex-col h-full bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Olá! Posso ajudar você a criar tarefas, atribuir pessoas, mudar status e etapas, ou criar automações. O que você gostaria de fazer?
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2">
            <Input
              placeholder="Pergunte à IA para automatizar tarefas..."
              value={aiQuery}
