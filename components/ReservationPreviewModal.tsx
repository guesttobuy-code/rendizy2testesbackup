          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-900">{reservation.guests?.total ?? '-'} pessoas</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-900">
                  R$ {(reservation?.pricing?.total ?? reservation?.price ?? 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                </div>
              </div>
            </div>
