# 🚀 PROTOCOLO DE INICIALIZAÇÃO DA IA - LEIA PRIMEIRO

> **📅 Última atualização**: 19/12/2024  
> **⏰ Reler este arquivo**: A cada 3 horas durante o dia

---

## ✅ CHECKLIST DE INICIALIZAÇÃO (EXECUTAR SEMPRE AO COMEÇAR)

### 1. 📖 LER DOCUMENTAÇÃO ESSENCIAL (2 minutos)
```powershell
# Contexto imediato para IA
code "docs/GUIA_RAPIDO_IA.md"

# Últimas mudanças
code "CHANGELOG.md"

# Log de hoje (se existir)
code "docs/dev-logs/$(Get-Date -Format 'yyyy-MM-dd')_*.md"
```

### 2. 🔍 VERIFICAR ESTADO ATUAL DO SISTEMA (1 minuto)
...
- "Continuar Issue #41 (calendario-v2) ou Issue #42 (datas)?"
- Nunca assumir - sempre perguntar primeiro

### 5. 🛠️ USAR O WORKFLOW PROFISSIONAL
Se for começar nova tarefa:
```powershell
.\start-task.ps1 "nome-da-tarefa"
```
...
- ❌ Modificar código sem perguntar
- ❌ Fazer deploy sem confirmação
- ❌ Deletar arquivos
- ❌ Alterar configurações do Supabase
- ❌ Criar commits sem usar `finish-task.ps1`

### ✅ SEMPRE FAZER:
- ✅ Ler `docs/GUIA_RAPIDO_IA.md` primeiro
- ✅ Usar `start-task.ps1` antes de começar
- ✅ Atualizar log com `update-log.ps1` durante trabalho
- ✅ Usar `finish-task.ps1` ao terminar
...
## 📊 STATUS ATUAL DO PROJETO (atualizado: 19/12/2024)

### 🔴 PENDENTE - Alta Prioridade
1. **Issue #42**: Corrigir datas hardcoded em `contexts/CalendarContext.tsx` (linhas 81-84)
   - Problema: Mostra Out/Nov 2025 ao invés de Dez 2024
   - Estimativa: 30 minutos

2. **Issue #41**: Ativar rota `/calendario-v2` no `App.tsx`
   - Problema: Refatoração 90% pronta mas rota não adicionada
   - Estimativa: 1 hora

### ✅ CONCLUÍDO RECENTEMENTE
- ✅ StaysNet 401 corrigido (headers `X-Auth-Token`)
- ✅ Sistema de documentação completo criado
- ✅ Workflow profissional implementado
- ✅ 3 scripts PowerShell de automação

---

## 💾 BACKUP E SEGURANÇA
**📁 Backup de Consulta**: `C:\Users\rafae\OneDrive\Desktop\RENDIZY_BACKUP_CONSULTA`
