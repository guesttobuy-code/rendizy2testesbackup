# Rendizy — schema consolidado (observado via migrations + 1 sample row) — 20251226-035608
...
| path | type | exemplo |
|---|---|---|
| financeiro_lancamentos.categoria_id | UUID | (missing) |
| financeiro_lancamentos.centro_custo_id | UUID | (missing) |
| financeiro_lancamentos.competencia | DATE | (missing) |
| financeiro_lancamentos.conciliado | BOOLEAN | (missing) |
| financeiro_lancamentos.conta_destino_id | UUID | (missing) |
| financeiro_lancamentos.conta_id | UUID | (missing) |
| financeiro_lancamentos.conta_origem_id | UUID | (missing) |
| financeiro_lancamentos.created_at | TIMESTAMPTZ | (missing) |
| financeiro_lancamentos.created_by | UUID | (missing) |
| financeiro_lancamentos.data | DATE | (missing) |
| financeiro_lancamentos.descricao | TEXT | (missing) |
| financeiro_lancamentos.documento | TEXT | (missing) |
| financeiro_lancamentos.has_split | BOOLEAN | (missing) |
| financeiro_lancamentos.id | UUID | (missing) |
| financeiro_lancamentos.linha_extrato_id | UUID | (missing) |
| financeiro_lancamentos.moeda | TEXT | (missing) |
| financeiro_lancamentos.nota_fiscal | TEXT | (missing) |
| financeiro_lancamentos.observacoes | TEXT | (missing) |
| financeiro_lancamentos.organization_id | UUID | (missing) |
| financeiro_lancamentos.property_id | TEXT | (missing) |
| financeiro_lancamentos.tipo | TEXT | (missing) |
| financeiro_lancamentos.updated_at | TIMESTAMPTZ | (missing) |
| financeiro_lancamentos.valor | NUMERIC(15, 2) | (missing) |
| financeiro_lancamentos.valor_convertido | NUMERIC(15, 2) | (missing) |

## financeiro_linhas_extrato
- Sample: **vazio** (0 registros retornados)
| path | type | exemplo |
|---|---|---|
| financeiro_linhas_extrato.conciliado | BOOLEAN | (missing) |
| financeiro_linhas_extrato.confianca_ml | NUMERIC(5, 2) | (missing) |
| financeiro_linhas_extrato.conta_id | UUID | (missing) |
| financeiro_linhas_extrato.created_at | TIMESTAMPTZ | (missing) |
| financeiro_linhas_extrato.data | DATE | (missing) |
| financeiro_linhas_extrato.descricao | TEXT | (missing) |
| financeiro_linhas_extrato.hash_unico | TEXT | (missing) |
| financeiro_linhas_extrato.id | UUID | (missing) |
| financeiro_linhas_extrato.lancamento_id | UUID | (missing) |
| financeiro_linhas_extrato.moeda | TEXT | (missing) |
| financeiro_linhas_extrato.organization_id | UUID | (missing) |
| financeiro_linhas_extrato.origem | TEXT | (missing) |
| financeiro_linhas_extrato.ref | TEXT | (missing) |
| financeiro_linhas_extrato.ref_banco | TEXT | (missing) |
| financeiro_linhas_extrato.sugestao_categoria_id | UUID | (missing) |
| financeiro_linhas_extrato.tipo | TEXT | (missing) |
| financeiro_linhas_extrato.valor | NUMERIC(15, 2) | (missing) |

## financeiro_regras_conciliacao
- Sample: **vazio** (0 registros retornados)
| path | type | exemplo |
|---|---|---|
| financeiro_regras_conciliacao.acao | TEXT | (missing) |
| financeiro_regras_conciliacao.aplicacoes | INTEGER | (missing) |
| financeiro_regras_conciliacao.ativo | BOOLEAN | (missing) |
| financeiro_regras_conciliacao.categoria_id | UUID | (missing) |
| financeiro_regras_conciliacao.centro_custo_id | UUID | (missing) |
| financeiro_regras_conciliacao.conta_contrapartida_id | UUID | (missing) |
| financeiro_regras_conciliacao.created_at | TIMESTAMPTZ | (missing) |
| financeiro_regras_conciliacao.created_by | UUID | (missing) |
| financeiro_regras_conciliacao.descricao | TEXT | (missing) |
| financeiro_regras_conciliacao.id | UUID | (missing) |
| financeiro_regras_conciliacao.nome | TEXT | (missing) |
| financeiro_regras_conciliacao.organization_id | UUID | (missing) |
| financeiro_regras_conciliacao.padrao_operador | TEXT | (missing) |
| financeiro_regras_conciliacao.padrao_termo | TEXT | (missing) |
| financeiro_regras_conciliacao.prioridade | INTEGER | (missing) |
| financeiro_regras_conciliacao.tipo_lancamento | TEXT | (missing) |
| financeiro_regras_conciliacao.ultima_aplicacao | TIMESTAMPTZ | (missing) |
| financeiro_regras_conciliacao.updated_at | TIMESTAMPTZ | (missing) |
| financeiro_regras_conciliacao.valor_a | NUMERIC(15, 2) | (missing) |
| financeiro_regras_conciliacao.valor_b | NUMERIC(15, 2) | (missing) |
| financeiro_regras_conciliacao.valor_operador | TEXT | (missing) |

## financeiro_titulos
- Sample: **vazio** (0 registros retornados)
| path | type | exemplo |
|---|---|---|
| financeiro_titulos.categoria_id | UUID | (missing) |
| financeiro_titulos.centro_custo_id | UUID | (missing) |
| financeiro_titulos.conta_id | UUID | (missing) |
| financeiro_titulos.created_at | TIMESTAMPTZ | (missing) |
| financeiro_titulos.created_by | UUID | (missing) |
| financeiro_titulos.desconto_antecipacao | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.descricao | TEXT | (missing) |
| financeiro_titulos.emissao | DATE | (missing) |
| financeiro_titulos.enviar_cobranca | BOOLEAN | (missing) |
| financeiro_titulos.frequencia | TEXT | (missing) |
| financeiro_titulos.guest_id | UUID | (missing) |
| financeiro_titulos.id | UUID | (missing) |
| financeiro_titulos.juros_calculado | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.moeda | TEXT | (missing) |
| financeiro_titulos.multa_calculada | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.numero | TEXT | (missing) |
| financeiro_titulos.observacoes | TEXT | (missing) |
| financeiro_titulos.organization_id | UUID | (missing) |
| financeiro_titulos.pagamento | DATE | (missing) |
| financeiro_titulos.parcela_atual | INTEGER | (missing) |
| financeiro_titulos.property_id | TEXT | (missing) |
| financeiro_titulos.proxima_cobranca | DATE | (missing) |
| financeiro_titulos.proxima_parcela | DATE | (missing) |
| financeiro_titulos.recorrente | BOOLEAN | (missing) |
| financeiro_titulos.reservation_id | UUID | (missing) |
| financeiro_titulos.status | TEXT | (missing) |
| financeiro_titulos.taxa_juros_mensal | NUMERIC(5, 2) | (missing) |
| financeiro_titulos.taxa_multa | NUMERIC(5, 2) | (missing) |
| financeiro_titulos.tipo | TEXT | (missing) |
| financeiro_titulos.titulo_pai_id | UUID | (missing) |
| financeiro_titulos.total_parcelas | INTEGER | (missing) |
| financeiro_titulos.ultima_cobranca | TIMESTAMPTZ | (missing) |
| financeiro_titulos.updated_at | TIMESTAMPTZ | (missing) |
| financeiro_titulos.valor_original | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.valor_pago | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.valor_restante | NUMERIC(15, 2) | (missing) |
| financeiro_titulos.vencimento | DATE | (missing) |
