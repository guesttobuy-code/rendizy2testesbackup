# Stays API — schema consolidado (observado) — 20251226-033325
...
| finance | _reports/staysnet-api-exports/finance-20251226-033324 | 0 | (n/a) |
...
### finance
- (export não encontrado ou incompleto)
