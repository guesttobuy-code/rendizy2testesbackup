# Stays vs Rendizy — conciliação de campos (com dados reais) — 20251226-040238
...
|---|---|---|---|---|---|---|
| reservations._id | 693bf2bd3a6d6379dd73a4c9 | reservations.id | TEXT | 677db72d44bf0257e2b1aef5 | EXISTS |  |
| reservations._idclient | 693bf2bb3a6d6379dd73a1b8 |  |  |  | MISSING | reservations.staysnet_raw — padrão: preservar no JSONB raw |
| reservations._idlisting | 67acf3502fe4d0496b8022eb |  |  |  | MISSING | reservations.staysnet_raw — padrão: preservar no JSONB raw |
...
| reservations.creationDate | 2025-12-12 |  |  |  | MISSING | reservations.staysnet_raw — padrão: preservar no JSONB raw |
| reservations.guests | 3 | reservations.guests_adults | INTEGER | 1 | EXISTS |  |
...
| reservations.id | RV02J | reservations.id | TEXT | 677db72d44bf0257e2b1aef5 | EXISTS |  |
| reservations.partner | {…} |  |  |  | MISSING | reservations.staysnet_raw — padrão: preservar no JSONB raw |
| reservations.partner._id | 5d1b5cbec62b271c78796479 | reservations.id | TEXT | 677db72d44bf0257e2b1aef5 | REVIEW |  |
...
| reservations.partnerCode | 6342499387 |  |  |  | MISSING | reservations.external_id — partnerCode pode ser external_id (ou coluna external_partner_code) |
...
| reservations.price._f_expected | 367.55 |  |  |  | MISSING | reservations.pricing_* — mapear para colunas pricing_ existentes quando possível; resto fica no staysnet_raw |
| reservations.price._f_total | 434.9 |  |  |  | MISSING | reservations.pricing_* — mapear para colunas pricing_ existentes quando possível; resto fica no staysnet_raw |
| reservations.price.currency | BRL | reservations.pricing_currency | TEXT | BRL | REVIEW |  |
...
| reservations.price.hostingDetails._f_nightPrice | 317.55 | reservations.pricing_price_per_night | NUMERIC(10, 2) | 0 | REVIEW |  |
...
| reservations.stats._f_totalPaid | 434.9 |  |  |  | MISSING | reservations.pricing_* — mapear para colunas pricing_ existentes quando possível; resto fica no staysnet_raw |
...
| listings._id | 63dd7e20333d8b60be510f9c | properties.id | text | 63e15fb0-bfed-47aa-9afd-071563e15fb0 | EXISTS |  |
...
| listings._idproperty | 63e16e00526be845bec4ff6b |  |  |  | MISSING | properties.* / listings.* — listings Stays pode virar properties (unidade) e/ou listings (plataforma) no Rendizy; decidir modelo |
...
| listings.id | PY02H | properties.id | text | 63e15fb0-bfed-47aa-9afd-071563e15fb0 | EXISTS |  |
...
| stays.path | stays.exemplo | rendizy.candidato | rendizy.type | rendizy.exemplo | status | sugestão (se faltar) |
|---|---|---|---|---|---|---|
| clients._id | 694df1fd93c911ce177b2f93 | guests.id | uuid | 9aa96aa3-61d6-4c0e-9f63-dc910cfb4917 | EXISTS |  |
...
| stays.path | stays.exemplo | rendizy.candidato | rendizy.type | rendizy.exemplo | status | sugestão (se faltar) |
|---|---|---|---|---|---|---|
| finance._id | 63d83d188e5afe3dd4648fda | financeiro_titulos.id | UUID | (missing) | EXISTS |  |
