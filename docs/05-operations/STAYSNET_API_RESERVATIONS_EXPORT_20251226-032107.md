# Stays API — reservations export (direto) — 20251226-032107
...
- Paginação: `limit=20`, `maxPages=5`, `startSkip=0`

## Saída
- Raw JSON: `_reports/staysnet-api-exports/reservations-20251226-032107/reservations_raw.json`
- Meta: `_reports/staysnet-api-exports/reservations-20251226-032107/meta.json`
...
- price.currency: BRL (100)
- stats._f_totalPaid: min=240.27 max=25667.26 (amostra com 100 valores numéricos)
