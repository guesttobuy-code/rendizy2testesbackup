-- ============================================================================
-- FIX: Atualizar TODAS as RPCs para usar public.properties (canônico)
-- Data: 2026-01-06
--
-- Problema:
-- - Algumas RPCs ainda referenciam public.anuncios_ultimate que foi renomeada para public.properties
-- - Erro: "relation 'public.anuncios_ultimate' does not exist"
--
-- Solução:
-- - Recriar save_anuncio_field e save_anuncio_batch usando public.properties
-- ============================================================================
...
DROP FUNCTION IF EXISTS public.save_anuncio_batch CASCADE;

-- ============================================================================
-- 2. RECRIAR save_anuncio_batch (usa properties)
-- ============================================================================
...
-- ============================================================================
-- 3. RECRIAR save_anuncio_field (wrapper → save_anuncio_batch)
-- ============================================================================
