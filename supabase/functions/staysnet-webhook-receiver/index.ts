/**
 * ╔══════════════════════════════════════════════════════════════════════════════╗
 * ║  🔗 EDGE FUNCTION: staysnet-webhook-receiver                                  ║
 * ║                                                                              ║
 ...
 * ║     Sempre que alterar routes-staysnet-webhooks.ts ou staysnet-db.ts,        ║
 * ║     DEVE fazer deploy DESTA função também!                                   ║
 * ║                                                                              ║
 * ║  💻 Comando: npm run deploy:webhooks                                         ║
 * ║     (ou manualmente: supabase functions deploy staysnet-webhook-receiver)    ║
 * ║                                                                              ║
