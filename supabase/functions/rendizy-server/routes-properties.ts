/**
 * ROTAS: Properties (Imóveis/Propriedades)
 * Gerenciamento completo de imóveis com sistema de drafts e publicação
 * 
 * @url /functions/v1/rendizy-server/properties/*
 * @table properties (antiga anuncios_ultimate)
 */
 ...
 * Lista todas as propriedades com todos os campos necessários para o calendário
 ...
 * Salva um campo da propriedade (usa RPC save_anuncio_field)
 */
...
/**
 * PATCH /properties/update-responsibility
...
/**
 * POST /properties/batch-update-responsibility
 * Atualiza responsabilidade de múltiplas propriedades de uma vez
